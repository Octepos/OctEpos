...
export const COMMERCIAL_WORKFLOWS: {
  ...
  {
    id: 'feddes-finance-risk',
    title: 'Client Risk Profile & Loan Portfolio Analysis',
    clientOrProject: 'Feddes Finance Ltd',
    ...
    attemptedUnauthorizedAction: 'LEDGER_MUTATION: UPDATE accounts SET credit_limit = 750000 WHERE client_id = "FED-8841"',
    ...
    artifactName: 'Feddes_Finance_Client_Risk_Evaluation_2026.pdf',
  ...
  {
    id: 'new-brighton-conversion',
    title: 'Asset Evaluation & Commercial Conversion Prospects',
    clientOrProject: '307 New Brighton Road',
    domain: 'Commercial Asset Conversion & Municipal Feasibility',
    intent: 'Parse Canterbury council zoning restrictions, estimate structural retrofit cost per square meter, calculate ROI cap rates, and synthesize feasibility report.',
    substrateId: 'gemini',
    commercialValue: 'Allocates heavy reasoning to scrape council data and draft structural feasibility reports. The Reference Monitor ensures this same intelligence cannot autonomously email property brokers or initiate unmetered spend on paid data APIs.',
    attemptedUnauthorizedAction: 'NET_EGRESS: POST https://api.propertydata-paid.internal/v2/bulk_query?cost=450usd & SMTP send to broker@commercial-realty.co.nz',
    ...
    artifactName: '307_New_Brighton_Rd_Commercial_Conversion_ROI.xlsx',
    artifactSnippet: 'Zoning: Commercial 2B Mixed-Use | Net Lettable Area: 1,480m² | Est. Conversion Capex: $1.85M | Stabilized Net Yield: 8.42%',
    status: 'IDLE'
  }
];
...
export const INITIAL_POLICY_DECISIONS: {
...
}[] = [
  {
    ...
    clientContext: '307 New Brighton Road',
    ...
    costSaved: '$450.00 unapproved spend',
  ...
  },
  {
    ...
    taskName: 'Analyze Client Loan Profile',
    clientContext: 'Feddes Finance Ltd',
  ...
  },
  {
    ...
    taskName: 'Sovereign Token Valuation Matrix',
    clientContext: 'Feddes Treasury Enclave',
    attemptedAction: 'VFS_ESCALATION (Attempted root filesystem write outside /workspace/ephemeral)',
    status: 'POLICY DENIAL',
    reason: 'Ephemeral hand memory space attenuated to temporary scratchpad. Physical process dropped upon artifact return.',
    costSaved: '$0.00 compute sunk',
...
export const CAPABILITY_ALLOCATION_MATRIX = [
  {
    ...
    commercialContext: 'Feddes Finance Confidential Records',
  ...
  },
  {
    ...
    commercialContext: 'Loan Underwriting Stress Testing',
  ...
  },
  {
    ...
    commercialContext: '307 New Brighton Rd Conversion',
